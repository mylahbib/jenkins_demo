...
public class CloudInfrastructureTest {
     ...
     * @throws CreateStoreException 
     */
    @Test
    public void can_create_a_store_in_cloud() throws CreateStoreException {
     ...
     */
    @Test
    public void can_create_multiple_stores_in_cloud() throws CreateStoreException {
        cloud.createStore("myFiles");
     ...
     */
//    @Test
    public void can_delete_and_empty_stores_in_cloud() throws CreateStoreException {
        cloud.createStore("myFiles");
        cloud.createStore("myImages");
        cloud.uploadDocument("myImages", "picture.jpeg", "profile.png");
